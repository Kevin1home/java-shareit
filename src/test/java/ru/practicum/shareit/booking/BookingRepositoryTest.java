...
class BookingRepositoryTest {
    ...
    void findAllByBookerId() {
        List<Booking> bookings = bookingRepository.getAllBookingsByBookerId(1L, PageRequest.of(0, 10));
    ...
    void findAllCurrentBookingsByBookerId() {
        List<Booking> bookings = bookingRepository.getAllCurrentBookingsByBookerId(1L, LocalDateTime.now(),
                PageRequest.of(0, 10));
    ...
    void findAllPastBookingsByBookerId() {
        List<Booking> bookings = bookingRepository.getAllPastBookingsByBookerId(1L, LocalDateTime.now(),
                PageRequest.of(0, 10));
    ...
    void findAllFutureBookingsByBookerId() {
        List<Booking> bookings = bookingRepository.getAllFutureBookingsByBookerId(1L, LocalDateTime.now(),
                PageRequest.of(0, 10));
    ...
    void findAllWaitingBookingsByBookerId() {
        ...
        List<Booking> bookings = bookingRepository.getAllWaitingBookingsByBookerId(1L, LocalDateTime.now(),
                PageRequest.of(0, 10));
    ...
    void findAllRejectedBookingsByBookerId() {
        ...
        List<Booking> bookings = bookingRepository.getAllRejectedBookingsByBookerId(1L, LocalDateTime.now(),
                PageRequest.of(0, 10));
    ...
    void findAllByOwnerId() {
        List<Booking> bookings = bookingRepository.getAllBookingsByOwnerId(2L, PageRequest.of(0, 10));
    ...
    void findAllCurrentBookingsByOwnerId() {
        List<Booking> bookings = bookingRepository.getAllCurrentBookingsByOwnerId(2L, LocalDateTime.now(),
                PageRequest.of(0, 10));
    ...
    void findAllPastBookingsByOwnerId() {
        List<Booking> bookings = bookingRepository.getAllPastBookingsByOwnerId(2L, LocalDateTime.now(),
                PageRequest.of(0, 10));
    ...
    void findAllFutureBookingsByOwnerId() {
        List<Booking> bookings = bookingRepository.getAllFutureBookingsByOwnerId(2L, LocalDateTime.now(),
                PageRequest.of(0, 10));
    ...
    void findAllWaitingBookingsByOwnerId() {
        ...
        bookingRepository.save(waitingBooking);
        List<Booking> bookings = bookingRepository.getAllWaitingBookingsByOwnerId(2L, LocalDateTime.now(),
                PageRequest.of(0, 10));
    ...
    void findAllRejectedBookingsByOwnerId() {
        ...
        bookingRepository.save(rejectedBooking);
        List<Booking> bookings = bookingRepository.getAllRejectedBookingsByOwnerId(2L,
                PageRequest.of(0, 10));
