...
class BookingServiceImplTest {
    ...
    void getById() {
        ...
        BookingDtoOut actualBookingDtoOut = bookingService.getBookingByUserId(user.getId(), booking.getId());
    ...
    void getByIdWhenBookingIdIsNotValidShouldThrowObjectNotFoundException() {
        ...
        NotFoundException bookingNotFoundException = assertThrows(NotFoundException.class,
                () -> bookingService.getBookingByUserId(1L, booking.getId()));
    ...
    void getByIdWhenUserIsNotItemOwnerShouldThrowObjectNotFoundException() {
        ...
        NotFoundException bookingNotFoundException = assertThrows(NotFoundException.class,
                () -> bookingService.getBookingByUserId(3L, booking.getId()));
    ...
    void getAllByBookerWhenBookingStateAll() {
        ...
        when(bookingRepository.getAllBookingsByBookerId(anyLong(), any(Pageable.class))).thenReturn(List.of(booking));
    ...
    void getAllByBooker_whenBookingStateCURRENT() {
        List<BookingDtoOut> expectedBookingsDtoOut = List.of(BookingMapper.toBookingOut(booking));
        when(userService.getById(user.getId())).thenReturn(userDto);
        when(bookingRepository.getAllCurrentBookingsByBookerId(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
    ...
    void getAllByBookerWhenBookingStatePAST() {
        List<BookingDtoOut> expectedBookingsDtoOut = List.of(BookingMapper.toBookingOut(booking));
        when(userService.getById(user.getId())).thenReturn(userDto);
        when(bookingRepository.getAllPastBookingsByBookerId(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
                .thenReturn(List.of(booking));
    ...
    void getAllByBookerWhenBookingStateFUTURE() {
        List<BookingDtoOut> expectedBookingsDtoOut = List.of(BookingMapper.toBookingOut(booking));
        when(userService.getById(user.getId())).thenReturn(userDto);
        when(bookingRepository.getAllFutureBookingsByBookerId(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
                .thenReturn(List.of(booking));
    ...
    void getAllByBookerWhenBookingStateWAITING() {
        List<BookingDtoOut> expectedBookingsDtoOut = List.of(BookingMapper.toBookingOut(booking));
        when(userService.getById(user.getId())).thenReturn(userDto);
        when(bookingRepository.getAllWaitingBookingsByBookerId(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
                .thenReturn(List.of(booking));
    ...
    void getAllByOwnerWhenBookingStateAll() {
        List<BookingDtoOut> expectedBookingsDtoOut = List.of(BookingMapper.toBookingOut(booking));
        when(userService.getById(user.getId())).thenReturn(userDto);
        when(bookingRepository.getAllBookingsByOwnerId(anyLong(), any(Pageable.class))).thenReturn(List.of(booking));
    ...
    void getAllByOwnerWhenBookingStateCURRENT() {
        List<BookingDtoOut> expectedBookingsDtoOut = List.of(BookingMapper.toBookingOut(booking));
        when(userService.getById(user.getId())).thenReturn(userDto);
        when(bookingRepository.getAllCurrentBookingsByOwnerId(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
                .thenReturn(List.of(booking));
    ...
    void getAllByOwnerWhenBookingStatePAST() {
        List<BookingDtoOut> expectedBookingsDtoOut = List.of(BookingMapper.toBookingOut(booking));
        when(userService.getById(user.getId())).thenReturn(userDto);
        when(bookingRepository.getAllPastBookingsByOwnerId(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
                .thenReturn(List.of(booking));
    ...
    void getAllByOwnerWhenBookingStateFUTURE() {
        List<BookingDtoOut> expectedBookingsDtoOut = List.of(BookingMapper.toBookingOut(booking));
        when(userService.getById(user.getId())).thenReturn(userDto);
        when(bookingRepository.getAllFutureBookingsByOwnerId(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
                .thenReturn(List.of(booking));
    ...
    void getAllByOwnerWhenBookingStateWAITING() {
        List<BookingDtoOut> expectedBookingsDtoOut = List.of(BookingMapper.toBookingOut(booking));
        when(userService.getById(user.getId())).thenReturn(userDto);
        when(bookingRepository.getAllWaitingBookingsByOwnerId(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
                .thenReturn(List.of(booking));
    ...
    void getAllByOwnerWhenBookingStateREJECTED() {
        List<BookingDtoOut> expectedBookingsDtoOut = List.of(BookingMapper.toBookingOut(booking));
        when(userService.getById(user.getId())).thenReturn(userDto);
        when(bookingRepository.getAllRejectedBookingsByOwnerId(anyLong(), any(Pageable.class)))
                .thenReturn(List.of(booking));
    ...
    void getAllByBookerWhenBookingStateREJECTED() {
        List<BookingDtoOut> expectedBookingsDtoOut = List.of(BookingMapper.toBookingOut(booking));
        when(userService.getById(user.getId())).thenReturn(userDto);
        when(bookingRepository.getAllRejectedBookingsByBookerId(anyLong(), any(LocalDateTime.class), any(Pageable.class)))
                .thenReturn(List.of(booking));
